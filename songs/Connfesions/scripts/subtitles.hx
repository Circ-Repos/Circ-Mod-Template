...
function postCreate() {
    ...
    subtitletext.y += 180;
    subtitletext.font = Paths.font("Roboto.ttf");
    ...
    parseSubtitles(Paths.file("songs/"+PlayState.SONG.meta.name+"/subtitles.srt"));
}
...
function parseSubtitles(path:String) {
    ...
    if (filecontents == null) {
        Logs.trace("Missing subtitle file for song: \""+PlayState.SONG.meta.displayname+"/"+PlayState.SONG.meta.name+"\" Proceeding without subtitles.", 1, 14);
    }
    else {
