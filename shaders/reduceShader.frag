...
void main() {
    ...
    vec2 scale = openfl_TextureSize / textureScale / 1.5;
    ...
    if (all(lessThanEqual(uv, vec2(1.0))))
        gl_FragColor = (
            ...
            texture2D(bitmap, uv + vec2(0.66666666666666666666666666666667, 0.0) / scale) +
            texture2D(bitmap, uv + vec2(1.0, 0.0) / scale) +
            texture2D(bitmap, uv + vec2(0.33333333333333333333333333333333, 0.25) / scale) +
            texture2D(bitmap, uv + vec2(0.66666666666666666666666666666667, 0.33333333333333333333333333333333) / scale) +
            texture2D(bitmap, uv + vec2(1.0, 0.33333333333333333333333333333333) / scale) +
            texture2D(bitmap, uv + vec2(0.33333333333333333333333333333333, 0.66666666666666666666666666666667) / scale) +
            texture2D(bitmap, uv + vec2(0.66666666666666666666666666666667, 0.66666666666666666666666666666667) / scale) +
            texture2D(bitmap, uv + vec2(1.0, 0.66666666666666666666666666666667) / scale) +
            texture2D(bitmap, uv + vec2(0.33333333333333333333333333333333, 1.0) / scale) +
            texture2D(bitmap, uv + vec2(0.66666666666666666666666666666667, 1.0) / scale) +
            texture2D(bitmap, uv + vec2(1.0, 1.0) / scale)
        ) / 13.0;
}