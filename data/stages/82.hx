...
function stepHit(curStep:Int) {
	switch(curStep){
		case 744:
			...
			FlxTween.tween(healthBar, {y: 100}, 0.7, {ease: FlxEase.circOut});
			FlxTween.tween(healthBarBG, {y: 95}, 0.7, {ease: FlxEase.circOut});
			FlxTween.tween(comboGroup, {y: -1200}, 0.7, {ease: FlxEase.circOut});
			for(i in [iconP1, iconP2]){
				FlxTween.tween(i, {y: 40}, 0.7, {ease: FlxEase.circOut});
			}
